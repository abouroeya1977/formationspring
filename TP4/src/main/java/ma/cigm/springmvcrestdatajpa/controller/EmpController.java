...
//		EmpVo vo=(EmpVo)request.getAttribute("emVo");
		service.save(emp);
	...
	/**
	 * Trier les employs par le nom de champs qu'on passe dans l'URL
	 */
	...
	@RequestMapping("/sort/{fieldName1}/{fieldName2}")
	public String sortBy2(@PathVariable(value="fieldName1") String fieldName1,@PathVariable(value="fieldName2") String fieldName2, Model m) {
		List<EmpVo> list = service.sortBy(fieldName1,fieldName2);
		m.addAttribute("maliste", list);
		return "viewemp";
	}
}