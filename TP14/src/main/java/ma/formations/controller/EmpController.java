...
import ma.formations.domaine.EmpPaginator;
...
public class EmpController {
	...
	public EmpPaginator pagination(@RequestParam Map<String, String> params) {
		return new EmpPaginator(
				service.findAll(Integer.parseInt(params.get("page")), Integer.parseInt(params.get("size"))), total());
	}
