package ma.formations.controller.unit.presentation.employees;
...
@WebMvcTest(controllers = EmpController.class, 
			...
			includeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = EmpController.class) })
